...
public class OmsOrderItemCommissionExample {
    ...
    public OmsOrderItemCommissionExample() {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        // Add criteria for other fields as needed, e.g., commissionRate, calculatedTime
