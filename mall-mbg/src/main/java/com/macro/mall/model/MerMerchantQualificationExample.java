...
public class MerMerchantQualificationExample {
    ...
    public MerMerchantQualificationExample() {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        // ... (add similar criteria for all other fields in MerMerchantQualification) ...
